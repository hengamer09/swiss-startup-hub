      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="rounded-full p-1.5 text-zinc-500 hover:bg-zinc-100 hover:text-zinc-800 transition-colors focus:outline-2 focus:outline-[#1e40af]"
          >
        ...
        {step === "select" && (
          <div className="space-y-3">
            <button
              ...
              className="w-full rounded-lg border border-zinc-200 p-4 text-left transition-all hover:border-zinc-300 hover:bg-zinc-50 focus:outline-2 focus:outline-[#1e40af]"
            >
        ...
        {step === "review" && (
          <div className="space-y-4">
            <div>
              <p className="text-sm font-medium text-zinc-700 mb-2" id="rating-label">Your rating <span className="text-[#1e40af]">*</span></p>
              <div className="flex gap-1" role="group" aria-labelledby="rating-label">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    className="focus:outline-2 focus:outline-[#1e40af] focus:rounded-sm"
                  >
                    <Star
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="issue-text" className="block text-sm font-medium text-zinc-700">
                What isn&apos;t working? <span className="text-[#1e40af]" aria-hidden="true">*</span>
        ...
        {step === "done" && (
          <div className="py-6 text-center">
            ...
            <button
              onClick={onClose}
              className="mt-4 rounded-md border border-zinc-300 px-5 py-2 text-sm font-medium text-zinc-700 hover:bg-zinc-50 transition-colors focus:outline-2 focus:outline-[#1e40af]"
            >
              Close
            </button>
          </div>
